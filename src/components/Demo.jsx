...
//                 <div className='max-w-md mt-0 text-center'>
...
//                 <div className="container flex flex-col items-center px-4 py-16 pb-24 mx-auto text-center lg:pb-56 md:py-32 md:px-10 lg:px-32 text-gray-90">
//                     <h1 className="text-5xl font-bold leading-none text-gray-800 sm:text-6xl xl:max-w-3xl">
//                         Welcome To Demo Home
//                     </h1>
...
//                     <button 
//                         type='button'
//                         className="px-8 py-3 m-2 text-lg font-semibold text-gray-900 transition-colors duration-200 rounded-full bg-violet-400 hover:bg-violet-600">
//                         Get started
//                     </button>
//                     </Link>
//                    <Link to="/about">
//                     <button
//                         type='button'
//                         className="px-8 py-3 m-2 text-lg text-gray-900 border rounded-full border-violet-400">
//                         Learn more
//                     </button>
//                    </Link>
//                     </div>
...
//             <img 
//             src={heroImg} alt="" 
//             className='w-5/6 mx-auto mb-12 -mt-20 bg-red-500 rounded-lg shadow-md lg:-mt-40'/>
//         </section>
//     );
// };
...
// const Demo = () => {
//     return (
//         <footer className="px-4 text-gray-800 divide-y">
...
//                             <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="currentColor" className="flex-shrink-0 w-5 h-5 rounded-full text-cyan-600">
...
//                 </div>
//             </div>
// 	        <div className="py-6 text-sm text-center text-gray-400">© 2022 Smart Home Inc. All rights reserved.</div>
//         </footer>
//     );
// };
